...
class GameOver(State):
    ...
    def setup_canvas(self):
        ...
        self.canvas.add_element(StaticBG([load_static("bricks")], (0, 0)), "")
        self.canvas.add_element(StaticBG([load_static("game_over")], (0, 0)), "")
        self.canvas.add_element(Button(load_some_sprites("quit"), (150, 200), BUTTON_DEFAULT, self.return_menu), "")
